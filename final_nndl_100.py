...
SumWriter = SummaryWriter(log_dir="transformer_100")
...
parser.add_argument('--outf1', default='./model/1', help='folder to output images and model checkpoints')
parser.add_argument('--outf2', default='./model/2', help='folder to output images and model checkpoints')
parser.add_argument('--outf3', default='./model/3', help='folder to output images and model checkpoints')
parser.add_argument('--outf4', default='./model/4', help='folder to output images and model checkpoints')# 输出结果保存路径
