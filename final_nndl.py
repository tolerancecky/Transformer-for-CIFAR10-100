...
SumWriter = SummaryWriter(log_dir="transformer_10_0")
...
parser.add_argument('--outf1', default='./model1_10_0', help='folder to output images and model checkpoints')
parser.add_argument('--outf2', default='./model2_10_0', help='folder to output images and model checkpoints')
parser.add_argument('--outf3', default='./model3_10_0', help='folder to output images and model checkpoints')
parser.add_argument('--outf4', default='./model4_10_0', help='folder to output images and model checkpoints')# 输出结果保存路径
